...
//			um.setVisible(true);
	...
	public static String getCBSCalendar() throws Exception{
		return TCPClient2.toServer("getCBSCalendar");
	}
	
	public static String getWeather() throws Exception{
		return TCPClient2.toServer("getClientForecast");
	}
	...
	public static boolean serverLogin(String username, String password) throws Exception{
		...
		if(TCPClient2.toServer(logininfo).equals("1")){
			return true;
		}else{
			return false;
		}
	...
	public static boolean createCalendar(String nameOfCalendar, String isActive, String madeBy, String isPrivateOrPublic)
	{
		String calendarName = nameOfCalendar;
		String Active = isActive; 
		String CreatedBy = madeBy;
		String PrivatePublic = isPrivateOrPublic;
		
		if (true)
		{
			System.out.println("kalender blev oprettet");
			return true;
		}
		else
		{
...
//	}
	...
	public static String getQOTD() throws Exception{
		QOTD = TCPClient2.toServer("getQuote");
		return QOTD;
	}
